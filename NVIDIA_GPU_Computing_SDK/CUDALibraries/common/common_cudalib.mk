...
ifneq ($(DARWIN),)
   LINK += -Xlinker -rpath $(SHAREDDIR)/lib/$(OSLOWER) -Xlinker -rpath $(CUDA_INSTALL_PATH)/lib
endif
...
ifeq ($(USEGLLIB),1)
    ifneq ($(DARWIN),)
        ...
        OPENGLLIB += -lGL -lGLU $(SHAREDDIR)/lib/$(OSLOWER)/libGLEW.a
    else
...
ifeq ($(USENVCUVID), 1)
    NVCUVIDLIB := -L../../common/lib/$(OSLOWER) -lnvcuvid
endif

ifeq ($(USEFREEIMAGE), 1)
    FREEIMAGELIB := -L$(SDK_INSTALL_DIR)/shared/lib/$(OSLOWER) -lfreeimage_$(OS_VERSION)
endif

# Libary definitions and paths
ifneq ($(DARWIN),)
...
ifeq ($(USEFREEIMAGE),1)
  ifneq ($(DARWIN),)
      ...
      FREEIMAGELIBARCH := $(LIB_BITS)	
  endif
  INCLUDES += -I../../common/FreeImage/include
  LIB += -L../../common/FreeImage/lib/$(OSLOWER) -lfreeimage$(FREEIMAGELIBARCH)
endif
